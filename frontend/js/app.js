...
// Hand-written, native-script text for every supported language so the
// spoken guide always matches the language the user selected.
const GUIDE = {
  en: {
  ...
  bn: {
    heading: "সরকারসাথী কীভাবে ব্যবহার করবেন",
    intro: "সরকারসাথীতে আপনাকে স্বাগতম। আমি আপনাকে সরকারি প্রকল্প খুঁজে পেতে সাহায্য করি। কণ্ঠস্বর দিয়ে আমাকে এভাবে ব্যবহার করুন।",
    steps: [
      "গোল মাইক্রোফোন বাটনে ট্যাপ করুন।",
      "এক বাক্যে নিজের কথা বলুন — আপনার বয়স, আপনার রাজ্য এবং আপনার কাজ।",
      "কিছুক্ষণ অপেক্ষা করুন। আমি আপনার জন্য উপযুক্ত প্রকল্প ও কত সুবিধা পাবেন তা দেখাব।",
      "আপনি বক্সে লিখতেও পারেন, বা নিচের সহজ ফর্মটি পূরণ করতে পারেন।",
    ],
    example: "উদাহরণ — বলুন: “আমি বিহারের ৬৫ বছর বয়সী অবসরপ্রাপ্ত ব্যক্তি, আমার আয় কম।”",
  },
  ta: {
    heading: "சர்க்கார்சாதியை எப்படி பயன்படுத்துவது",
    intro: "சர்க்கார்சாதிக்கு வரவேற்கிறோம். நீங்கள் பெறக்கூடிய அரசு திட்டங்களைக் கண்டறிய நான் உதவுகிறேன். குரல் மூலம் என்னை இப்படி பயன்படுத்தலாம்.",
    steps: [
      "வட்ட வடிவ மைக்ரோஃபோன் பொட்டனைத் தட்டவும்.",
      "உங்களைப் பற்றி ஒரு வாக்கியத்தில் பேசுங்கள் — உங்கள் வயது, உங்கள் மாநிலம், மற்றும் உங்கள் தொழில்.",
      "சிறிது நேரம் காத்திருங்கள். நீங்கள் பெறக்கூடிய திட்டங்களையும் எவ்வளவு பலன் கிடைக்கும் என்பதையும் காண்பிப்பேன்.",
      "பெட்டியில் தட்டச்சு செய்யலாம், அல்லது கீழே உள்ள எளிய படிவத்தை நிரப்பலாம்.",
    ],
    example: "எடுத்துக்காட்டு — சொல்லுங்கள்: “நான் பீகாரைச் சேர்ந்த 65 வயது ஓய்வுபெற்றவர், எனது வருமானம் குறைவு.”",
  },
  te: {
    heading: "సర్కార్‌సాథీని ఎలా ఉపయోగించాలి",
    intro: "సర్కార్‌సాథీకి స్వాగతం. మీరు పొందగలిగే ప్రభుత్వ పథకాలను కనుగొనడంలో నేను సహాయం చేస్తాను. వాయిస్ ద్వారా నన్ను ఎలా ఉపయోగించాలో ఇక్కడ ఉంది.",
    steps: [
      "గుండ్రని మైక్రోఫోన్ బటన్‌ను నొక్కండి.",
      "మీ గురించి ఒక వాక్యంలో చెప్పండి — మీ వయస్సు, మీ రాష్ట్రం, మరియు మీ పని.",
      "కొంచెం సేపు వేచి ఉండండి. మీరు పొందగల పథకాలను, ఎంత ప్రయోజనం లభిస్తుందో చూపిస్తాను.",
      "మీరు బాక్స్‌లో టైప్ చేయవచ్చు, లేదా దిగువ సాధారణ ఫారమ్‌ను పూరించవచ్చు.",
    ],
    example: "ఉదాహరణ — ఇలా చెప్పండి: “నేను బీహార్‌కు చెందిన 65 సంవత్సరాల విశ్రాంత వ్యక్తిని, నా ఆదాయం తక్కువ.”",
  },
  mr: {
    heading: "सरकारसाथी कसे वापरावे",
    intro: "सरकारसाथीमध्ये आपले स्वागत आहे. मी तुम्हाला मिळू शकणाऱ्या सरकारी योजना शोधण्यात मदत करतो. आवाजाने मला असे वापरा.",
    steps: [
      "गोल माइक बटण दाबा.",
      "एका वाक्यात स्वतःबद्दल सांगा — तुमचे वय, तुमचे राज्य आणि तुमचे काम.",
      "थोडा वेळ थांबा. मी तुम्हाला मिळू शकणाऱ्या योजना आणि किती लाभ मिळेल हे दाखवेन.",
      "तुम्ही बॉक्समध्ये टाइप देखील करू शकता, किंवा खालील सोपा फॉर्म भरू शकता.",
    ],
    example: "उदाहरण — असे म्हणा: “मी बिहारमधील ६५ वर्षांचा निवृत्त व्यक्ती आहे, माझे उत्पन्न कमी आहे.”",
  },
  kn: {
    heading: "ಸರ್ಕಾರ್‌ಸಾಥಿಯನ್ನು ಹೇಗೆ ಬಳಸುವುದು",
    intro: "ಸರ್ಕಾರ್‌ಸಾಥಿಗೆ ಸ್ವಾಗತ. ನೀವು ಪಡೆಯಬಹುದಾದ ಸರ್ಕಾರಿ ಯೋಜನೆಗಳನ್ನು ಹುಡುಕಲು ನಾನು ಸಹಾಯ ಮಾಡುತ್ತೇನೆ. ಧ್ವನಿಯ ಮೂಲಕ ನನ್ನನ್ನು ಹೀಗೆ ಬಳಸಿ.",
    steps: [
      "ದುಂಡಾದ ಮೈಕ್ರೊಫೋನ್ ಬಟನ್ ಒತ್ತಿರಿ.",
      "ನಿಮ್ಮ ಬಗ್ಗೆ ಒಂದು ವಾಕ್ಯದಲ್ಲಿ ಹೇಳಿ — ನಿಮ್ಮ ವಯಸ್ಸು, ನಿಮ್ಮ ರಾಜ್ಯ ಮತ್ತು ನಿಮ್ಮ ಕೆಲಸ.",
      "ಸ್ವಲ್ಪ ಕಾಯಿರಿ. ನೀವು ಪಡೆಯಬಹುದಾದ ಯೋಜನೆಗಳನ್ನು ಮತ್ತು ಎಷ್ಟು ಪ್ರಯೋಜನ ಸಿಗುತ್ತದೆ ಎಂಬುದನ್ನು ನಾನು ತೋರಿಸುತ್ತೇನೆ.",
      "ನೀವು ಬಾಕ್ಸ್‌ನಲ್ಲಿ ಟೈಪ್ ಮಾಡಬಹುದು, ಅಥವಾ ಕೆಳಗಿನ ಸರಳ ಫಾರ್ಮ್ ಅನ್ನು ಭರ್ತಿ ಮಾಡಬಹುದು.",
    ],
    example: "ಉದಾಹರಣೆ — ಹೀಗೆ ಹೇಳಿ: “ನಾನು ಬಿಹಾರದ 65 ವರ್ಷದ ನಿವೃತ್ತ ವ್ಯಕ್ತಿ, ನನ್ನ ಆದಾಯ ಕಡಿಮೆ.”",
  },
  gu: {
    heading: "સરકારસાથીનો ઉપયોગ કેવી રીતે કરવો",
    intro: "સરકારસાથીમાં તમારું સ્વાગત છે. હું તમને મળી શકે તેવી સરકારી યોજનાઓ શોધવામાં મદદ કરું છું. અવાજ દ્વારા મને આ રીતે વાપરો.",
    steps: [
      "ગોળ માઇક્રોફોન બટન દબાવો.",
      "એક વાક્યમાં તમારા વિશે કહો — તમારી ઉંમર, તમારું રાજ્ય અને તમારું કામ.",
      "થોડી વાર રાહ જુઓ. હું તમને મળી શકે તેવી યોજનાઓ અને કેટલો લાભ મળશે તે બતાવીશ.",
      "તમે બોક્સમાં ટાઇપ પણ કરી શકો છો, અથવા નીચે આપેલું સરળ ફોર્મ ભરી શકો છો.",
    ],
    example: "ઉદાહરણ — આમ કહો: “હું બિહારનો 65 વર્ષનો નિવૃત્ત વ્યક્તિ છું, મારી આવક ઓછી છે.”",
  },
  pa: {
    heading: "ਸਰਕਾਰਸਾਥੀ ਦਾ ਉਪਯੋਗ ਕਿਵੇਂ ਕਰੀਏ",
    intro: "ਸਰਕਾਰਸਾਥੀ ਵਿੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ। ਮੈਂ ਤੁਹਾਨੂੰ ਮਿਲ ਸਕਣ ਵਾਲੀਆਂ ਸਰਕਾਰੀ ਯੋਜਨਾਵਾਂ ਲੱਭਣ ਵਿੱਚ ਮਦਦ ਕਰਦਾ ਹਾਂ। ਆਵਾਜ਼ ਨਾਲ ਮੈਨੂੰ ਇਸ ਤਰ੍ਹਾਂ ਵਰਤੋ।",
    steps: [
      "ਗੋਲ ਮਾਈਕ੍ਰੋਫ਼ੋਨ ਬਟਨ ਦਬਾਓ।",
      "ਇੱਕ ਵਾਕ ਵਿੱਚ ਆਪਣੇ ਬਾਰੇ ਦੱਸੋ — ਆਪਣੀ ਉਮਰ, ਆਪਣਾ ਰਾਜ ਅਤੇ ਆਪਣਾ ਕੰਮ।",
      "ਥੋੜ੍ਹੀ ਦੇਰ ਉਡੀਕ ਕਰੋ। ਮੈਂ ਤੁਹਾਨੂੰ ਮਿਲ ਸਕਣ ਵਾਲੀਆਂ ਯੋਜਨਾਵਾਂ ਅਤੇ ਕਿੰਨਾ ਲਾਭ ਮਿਲੇਗਾ, ਇਹ ਦਿਖਾਵਾਂਗਾ।",
      "ਤੁਸੀਂ ਬਾਕਸ ਵਿੱਚ ਟਾਈਪ ਵੀ ਕਰ ਸਕਦੇ ਹੋ, ਜਾਂ ਹੇਠਾਂ ਦਿੱਤਾ ਸਧਾਰਨ ਫਾਰਮ ਭਰ ਸਕਦੇ ਹੋ।",
    ],
    example: "ਉਦਾਹਰਨ — ਇਹ ਕਹੋ: “ਮੈਂ ਬਿਹਾਰ ਦਾ 65 ਸਾਲ ਦਾ ਸੇਵਾਮੁਕਤ ਵਿਅਕਤੀ ਹਾਂ, ਮੇਰੀ ਆਮਦਨ ਘੱਟ ਹੈ।”",
  },
  ml: {
    heading: "സർക്കാർസാഥി എങ്ങനെ ഉപയോഗിക്കാം",
    intro: "സർക്കാർസാഥിയിലേക്ക് സ്വാഗതം. നിങ്ങൾക്ക് ലഭിക്കാവുന്ന സർക്കാർ പദ്ധതികൾ കണ്ടെത്താൻ ഞാൻ സഹായിക്കുന്നു. ശബ്ദത്തിലൂടെ എന്നെ ഇങ്ങനെ ഉപയോഗിക്കുക.",
    steps: [
      "വൃത്താകൃതിയിലുള്ള മൈക്രോഫോൺ ബട്ടൺ അമർത്തുക.",
      "നിങ്ങളെക്കുറിച്ച് ഒരു വാക്യത്തിൽ പറയുക — നിങ്ങളുടെ വയസ്സ്, സംസ്ഥാനം, ജോലി.",
      "ഒരു നിമിഷം കാത്തിരിക്കുക. നിങ്ങൾക്ക് ലഭിക്കാവുന്ന പദ്ധതികളും എത്ര ആനുകൂല്യം ലഭിക്കുമെന്നും ഞാൻ കാണിക്കും.",
      "നിങ്ങൾക്ക് ബോക്സിൽ ടൈപ്പ് ചെയ്യാം, അല്ലെങ്കിൽ താഴെയുള്ള ലളിതമായ ഫോം പൂരിപ്പിക്കാം.",
    ],
    example: "ഉദാഹരണം — ഇങ്ങനെ പറയുക: “ഞാൻ ബീഹാറിൽ നിന്നുള്ള 65 വയസ്സുള്ള വിരമിച്ച വ്യക്തിയാണ്, എന്റെ വരുമാനം കുറവാണ്.”",
  },
  or: {
    heading: "ସରକାରସାଥୀ କିପରି ବ୍ୟବହାର କରିବେ",
    intro: "ସରକାରସାଥୀକୁ ସ୍ୱାଗତ। ଆପଣ ପାଇପାରୁଥିବା ସରକାରୀ ଯୋଜନାଗୁଡ଼ିକ ଖୋଜିବାରେ ମୁଁ ଆପଣଙ୍କୁ ସାହାଯ୍ୟ କରେ। ସ୍ୱର ଦ୍ୱାରା ମୋତେ ଏହିପରି ବ୍ୟବହାର କରନ୍ତୁ।",
    steps: [
      "ଗୋଲାକାର ମାଇକ୍ରୋଫୋନ୍ ବଟନ୍‌ରେ ଟାପ୍ କରନ୍ତୁ।",
      "ଏକ ବାକ୍ୟରେ ଆପଣଙ୍କ ବିଷୟରେ କୁହନ୍ତୁ — ଆପଣଙ୍କ ବୟସ, ଆପଣଙ୍କ ରାଜ୍ୟ ଏବଂ ଆପଣଙ୍କ କାମ।",
      "କିଛି ସମୟ ଅପେକ୍ଷା କରନ୍ତୁ। ମୁଁ ଆପଣ ପାଇପାରୁଥିବା ଯୋଜନା ଏବଂ କେତେ ଲାଭ ମିଳିବ ତାହା ଦେଖାଇବି।",
      "ଆପଣ ବକ୍ସରେ ଟାଇପ୍ ମଧ୍ୟ କରିପାରିବେ, କିମ୍ବା ତଳେ ଥିବା ସରଳ ଫର୍ମ ପୁରଣ କରିପାରିବେ।",
    ],
    example: "ଉଦାହରଣ — କୁହନ୍ତୁ: “ମୁଁ ବିହାରର 65 ବର୍ଷୀୟ ଅବସରପ୍ରାପ୍ତ ବ୍ୟକ୍ତି, ମୋର ଆୟ କମ୍।”",
  },
};
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  el("viewSchemesBtn").addEventListener("click", () => {
...
function render(res) {
  ...
  // Show view schemes button if there are schemes matched.
  const hasSchemes = res.schemes && res.schemes.length > 0;
  el("schemesAction").classList.toggle("d-none", !hasSchemes);
...
function guideContent() {
  // Every supported language now has hand-written native-script text, so the
  // spoken guide and the on-screen text always match the selected language.
...
function setBusy(b) {
  ...
  if (b) {
    ...
    el("schemesAction").classList.add("d-none");
    el("placeholder").classList.add("d-none");
